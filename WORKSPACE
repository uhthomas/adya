...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_proto/archive/e51f588e5932966ab9e63e0b0f6de6f740cf04c4.tar.gz"],
)
...
http_archive(
    ...
    urls = [
        ...
        "https://github.com/bazelbuild/rules_go/releases/download/v0.38.1/rules_go-v0.24.5.tar.gz",
    ],
)
